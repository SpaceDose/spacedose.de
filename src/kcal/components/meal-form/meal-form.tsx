	...
	return (
		<div className="flex grow flex-col gap-4 overflow-hidden pb-4">
			<form onBlur={submit} className="flex flex-col gap-2 px-4">
				<p className="font-thin text-sm">Meal</p>
			...
			<div className="flex grow flex-col overflow-hidden border-y pt-4">
				<p className="px-4 font-thin text-sm">Entries</p>
						...
						>
							<div className="flex size-full items-center justify-between gap-8 px-2">
								...
								<div className="flex shrink-0 flex-col text-right">
									...
									<p className="font-thin text-purple-light text-xs">{`${entry.gram}g / ${entry.kcal}kcal`}</p>
								</div>
							</div>
						</SlideRow>
					))}
